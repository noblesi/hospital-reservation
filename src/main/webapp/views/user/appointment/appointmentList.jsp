...
<body>
	...
	<div class="mainWrap">
		...
		<div class="warnNotiDiv">
			...
			<p class="warnNotiP">
				진료예약취소는 <span class="blue">진료일 이전(자정)</span>까지 가능합니다.(수납기록 및 검사예약이 없는 진료만 변경/취소가 가능)<br>
		...
		<div class="requireNotiDiv">
			...
			<p class="requireNotiP">
				...
				<span class="blue">건강보험 환자는</span> 1단계 요양급여를 제공하는 의료기관(의원·병원급-한방포함)에서 발금한 요양급여의뢰서(진료의뢰서)를<br>
