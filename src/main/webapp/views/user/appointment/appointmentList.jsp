...
<title>진료예약확인 | KCMH 한국중앙병원</title>
...
<body>
	...
	<div class="mainWrap">
		...
		<div class="requireNotiDiv">
			...
			<p class="requireNotiP">
				건강보험 환자 중 <span class="blue">가정의학과 진료, 분만 시, 혈우병 환자</span>의 경우 요양급여의뢰서는 없어도 됩니다.<br>
		...
		<div class="useNotiDiv">
			...
			<p>
				...
				- 진료 시간 간격이 좁은 경우는 진료과마다 진료 대기 시간이 길어질 수 있으므로 이후 진료과 담당 간호사에게 미리 양해를 구해 놓아 주시기 바랍니다.
			</p>
		</div>
	</div>
