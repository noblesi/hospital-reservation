			...
			<div class="deptWrap focusBorder">
				...
				<div class="searchBar">
					<div class="sortRadioDiv">
						<input type="radio" name="sort" value="default" id="deRadio" class="form-check-input" checked="checked"> <label for="deRadio" class="form-check-label">기본</label> <input type="radio" name="sort" value="ascending" id="ascRadio" class="form-check-input"> <label for="ascRadio" class="form-check-label">가나다순</label>
					</div>
					<div class="dNameInputDiv">
						<input type="text" placeholder="질병명 또는 의료진명" id="dNameInput">
						<button id="searchBtn">
							<img class="searchImg" src="http://192.168.10.80/hospital-reservation/resources/images/appointment/search.png">
						</button>
					</div>
				</div>
				...
				<div class="deptListDiv">
					...
					<button type="button" class="btnPrev">
						<img class="arrowIcon" src="http://192.168.10.80/hospital-reservation/resources/images/appointment/left.png">
					</button>
						...
						<div class="sliderTrack">
							<div class="sliderPage">
								<table class="slTab">
									<tr class="slRow">
										<td class="slCol">
											<input type="radio" value="진료과코드" class="deptRadio" id="deptx1" style="display: none;"> <label for="deptx1">내과0</label>
										</td>
										<td class="slCol">
											<input type="radio" value="진료과코드" class="deptRadio" style="display: none;"> <label for="dept1">외과0</label>
										</td>
										<td class="slCol">
											<input type="radio" value="진료과코드" class="deptRadio" style="display: none;"> <label for="dept1">소아과0</label>
										</td>
									</tr>
									<tr class="slRow">
										<td>
											<input type="radio" value="진료과코드" class="deptRadio" style="display: none;"> <label for="dept1">내과</label>
										</td>
										<td>
											<input type="radio" value="진료과코드" class="deptRadio" style="display: none;"> <label for="dept1">외과</label>
										</td>
										<td>
											<input type="radio" value="진료과코드" class="deptRadio" style="display: none;"> <label for="dept1">소아과</label>
										</td>
									</tr>
									<tr class="slRow">
										<td>
							...
							<div class="sliderPage">
								<table class="slTab">
									<tr class="slRow">
										<td class="slCol">
											<input type="radio" value="진료과코드" class="deptRadio" style="display: none;"> <label for="dept1">내과1</label>
										</td>
										<td class="slCol">
											<input type="radio" value="진료과코드" class="deptRadio" style="display: none;"> <label for="dept1">외과1</label>
										</td>
										<td class="slCol">
											<input type="radio" value="진료과코드" class="deptRadio" style="display: none;"> <label for="dept1">소아과1</label>
										</td>
									</tr>
									<tr class="slRow">
										<td>
					...
					<button type="button" class="btnNext">
						<img class="arrowIcon" src="http://192.168.10.80/hospital-reservation/resources/images/appointment/right.png">
					</button>
				</div>
			</div>
