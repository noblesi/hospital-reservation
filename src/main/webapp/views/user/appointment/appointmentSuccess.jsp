	...
	<div id="mainWrap">
		<div id="scsContainer">
			...
			<div class="noticeDiv">
				...
				<p>
					<span class="blue">건강보험 환자 중 가정의학과 진료, 분만 시, 혈우병 환자의 경우 요양급여의뢰서가 없어도 됩니다.</span><br> 또한, 장애인복지법에 의한 등록 장애인 또는 단순 물리치료가 아닌 작업치료·운동치료 등의 재활치료가 필요하다고 인정되는 자가<br> 재활의학과 진료를 볼 경우도 요양급여의뢰서가 없어도 됩니다.
				</p>
			</div>
		</div>
	</div>
