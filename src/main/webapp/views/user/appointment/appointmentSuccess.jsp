...
<!-- 외부 JS -->
<script src="${pageContext.request.contextPath}/resources/js/appointmentSuccess.js"></script>
</head>
	...
	<div id="mainWrap">
		<div id="container">
			...
			<div class="noticeDiv">
				...
				<p class="warningNoti">
					<span>1. 진료예약취소는 진료일 이전 자정(12시)까지 가능합니다.</span><br>
					<span class="subNoti">- 수납기록 및 검사예약이 없는 진료의 변경/취소가 가능합니다.</span><br>
					<span>2. 진료예약 제한 안내</span><br>
					<span class="subNoti">- 예약변경/취소 없이 진료를 받지 않을 경우 홈페이지 진료예약서비스가 제한됩니다.</span><br>
				</p>
				...
				<p class="requireP">
					<span class="red">신환,초진 진료</span>인 경우, <span class="red">요양급여의뢰서(진료의뢰서)</span>를 반드시 지참해야 합니다.<br>
					본원은 2단계 요양급여를 제공하는 상급종합병원입니다.<br>
					건강보험 환자는 1단계 요양급여를 제공하는 의료기관(의원급·병원급-한방포함)에서 발급한 요양급여의뢰서(진료의뢰서)를 제출해야하며,<br>
					의료급여 환자는 2차, 3차 의료급여기관(병원급 이상)에서 발급한 의료급여의뢰서를 제출해야만 요양급여를 받을 수 있습니다.<br>
				</p>
				<p>
					<span class="blue">건강보험 환자 중 가정의학과 진료, 분만 시, 혈우병환자의 경우 요양급여의뢰서가 없어도 됩니다.</span><br>
					또한, 장애인복지법에 의한 등록 장애인 또는 단순 물리치료가 아닌 작업치료·운동치료 등의 재활치료가 필요하다고 인정되는 자가<br>
					재활의학과 진료를 볼 경우도 요양급여의뢰서가 없어도 됩니다.
				</p>
			</div>
		</div>
	</div>
