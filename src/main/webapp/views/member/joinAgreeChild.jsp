...
<main id="content" class="memJoinContent">
    ...
    <form>
        <fieldset>
            ...
            <div class="boxTypeGray checkAllBox">
                <input type="checkbox" id="checkbox00" title="이용약관, 개인정보처리방침 모두 동의">
                <label for="checkbox00">이용약관, 개인정보 수집 이용 <b>모두</b> 동의합니다.</label>
            </div>
            ...
            <div class="persInforWrap">
                ...
                <div class="scrollBox">
                    <div class="innerScroll">
                        ...
                        <p class="colorPoint">
                            <u>
                                홈페이지 회원가입 탈퇴 시까지 또는 회원가입 시 선택한 보유기간까지 보유합니다.
                            </u>
                        </p>
                    </div>
                </div>
    ...
    <form id="gForm" name="gForm" action="<c:url value='joinForm.jsp' />" method="post">
